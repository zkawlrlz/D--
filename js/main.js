(function() {
  ...
  // 내용
  let descs = [
    '첫번째 외주작업인 코인어스 웹에서는 웹 퍼포먼스와 반응형 인터페이스에 주력했으며,<br>효과적인 팀 커뮤니케이션으로 작업을 원활히 진행하려고 노력했습니다. <br>팀워크와 커뮤니케이션의 중요성에 대해 깨달은 프로젝트였습니다.',
    '두 번째 외주작업 KB E-HRD 프로젝트는 편안한 사용자 경험에 중요한 가치를 두고 작업했습니다.<br>프로젝트의 목적성과 경험을 최대한 해치지 않으면서, 빠른 시일내에 완성도 높은 결과물을<br> 제작해야 했기 때문에, 역량 발휘와 성장에 큰 도움이 되었던 작업이었습니다.',
    '가치삽시다는 라이브커머스 사이트로 웹과 모바일에서 동일한 경험을<br>제공하는 것이 필요했습니다. 그래서 반응형 개발에 초점을 맞추어서<br> 같은 사용자 경험을 주는 것을 목표로 작업한 프로젝트 였습니다',
  ...
  let descs_m = [
    ...
    '#편안한 사용자 경험<br>#완성도<br>#외주작업',
    '#반응형 인터페이스<br>#라이브커머스<br>#외주작업',
    '#javascript<br>#DOM<br>#개인프로젝트',
    '#애니메이션<br>#뮤직 플레이어<br>#개인프로젝트',
    '#리디자인<br>#개인프로젝트',
    '#라이브러리 디자인<br>#개인프로젝트',
    '#SCSS<br>#keyframe<br>#3d'
  ]
